...
// Auth: any tenant user (single-account model) or master.
...
// Tenant users are always scoped to their own tenantId; scope/tenantId params are ignored for them.
...
export async function GET(req: NextRequest) {
  ...
  const isMaster      = isMasterRole(session.user.role)
